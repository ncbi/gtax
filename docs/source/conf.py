...
latex_documents = [(master_doc, 'gtax.tex', u'GTAX Documentation', u'Roberto Vera Alvarez', 'manual'), ]

# -- Options for manual page output ---------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, 'gtax', u'gtax Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'GTAX', u'GTAX Documentation', author, 'GTAX', 'One line description of project.', 'Miscellaneous'), ]
